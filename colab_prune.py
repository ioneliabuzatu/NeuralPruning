...
class opt():
    model_def = "/content/YOLOv3-model-pruning/config/yolov3-hand.cfg"
    data_config = "/content/YOLOv3-model-pruning/config/coco_colab.data"
    model = '/content/PyTorch-YOLOv3/weights/yolov3.weights'
...
pruned_cfg_name = "/content/YOLOv3-model-pruning/pruned-model/pruned.cfg"
pruned_cfg_file = write_cfg(pruned_cfg_name, [model.hyperparams.copy()] + compact_module_defs)
print(f'Config file has been saved: {pruned_cfg_file}')
#
compact_model_name = "/content/YOLOv3-model-pruning/pruned-model/pruned.pth"
